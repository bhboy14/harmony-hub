...
import { Loader2, Youtube, HardDrive, ChevronLeft, ChevronRight, User, ListMusic, Moon, Clock, Library, Cloud } from "lucide-react";
              ...
              <div className="p-6 h-full animate-fade-in overflow-y-auto custom-scrollbar pb-32">
                <Tabs defaultValue="unified" className="space-y-6">
                  <TabsList className="bg-secondary">
                    ...
                    <TabsTrigger value="soundcloud" className="gap-2 data-[state=active]:bg-foreground data-[state=active]:text-background">
                  ...
                  <TabsContent value="soundcloud" className="h-[calc(100vh-14rem)]">
                    <SoundCloudPlayer />
                  </TabsContent>
